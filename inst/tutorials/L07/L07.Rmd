...
请同学们点击下面的 [Generate] 按钮在方框中生成答案的 hash 码，然后点击方框右上角上的复制按钮，并将得到的hash码直接粘贴到 [坚果云 Excel 表格收集表 QFwR-L07](https://workspace.jianguoyun.com/inbox/collect/e8fbe742050c4f90891929795b98e680/submit) 中。
...
接下来你可在 `RStudio` 的 Console 中键入如下命令调出本讲练习的 `RMarkdown` 文档（`L07-lab.Rmd`），根据提示完成上机实操练习。
